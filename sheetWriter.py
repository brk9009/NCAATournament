...
class SheetWriter():
    ...
    def write_headers(self):
        ...
        self.worksheet.write('D1', 'NET', self.header_format)
        self.worksheet.write('E1', 'KevPauga', self.header_format)
        self.worksheet.write('F1', 'ESPN SoR', self.header_format)
        self.worksheet.write('G1', 'BPI', self.header_format)
        self.worksheet.write('H1', 'KenPom', self.header_format)
        self.worksheet.write('I1', 'Sagarin', self.header_format)
        self.worksheet.write('J1', 'Quad1', self.header_format)
        self.worksheet.write('K1', 'Quad2', self.header_format)
        self.worksheet.write('L1', 'Quad3', self.header_format)
        self.worksheet.write('M1', 'Quad4', self.header_format)
