...
class SheetWriter():
    ...
    def write_headers(self):
        ...
        self.worksheet.write('D1', 'Metric Avg', self.header_format)
        self.worksheet.write('E1', 'WAB', self.header_format)
        self.worksheet.write('F1', 'SOR', self.header_format)
        self.worksheet.write('G1', 'Torvik', self.header_format)
        self.worksheet.write('H1', 'BPI', self.header_format)
        self.worksheet.write('I1', 'NET', self.header_format)
        self.worksheet.write('J1', 'KPI', self.header_format)
        self.worksheet.write('K1', 'KenPom', self.header_format)
        self.worksheet.write('L1', 'Quad1', self.header_format)
        self.worksheet.write('M1', 'Quad2', self.header_format)
        self.worksheet.write('N1', 'Quad3', self.header_format)
        self.worksheet.write('O1', 'Quad4', self.header_format)
        self.worksheet.write('P1', 'Non-Con SoS', self.header_format)
